...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT
{
    ...
    explicit CD3DX12_SUBRESOURCE_FOOTPRINT(const D3D12_RESOURCE_DESC &resDesc, UINT rowPitch)
    {
        ...
        Depth  = (resDesc.Dimension == D3D12_RESOURCE_DIMENSION_TEXTURE3D ? resDesc.DepthOrArraySize
                                                                         : 1);
        RowPitch = rowPitch;
    }
};
...
struct CD3DX12_STATIC_SAMPLER_DESC : public D3D12_STATIC_SAMPLER_DESC
{
    ...
    inline void Init(UINT shaderRegister,
                     ...
                     UINT registerSpace                       = 0)
    {
        Init(*this, shaderRegister, filter, addressU, addressV, addressW, mipLODBias, maxAnisotropy,
             comparisonFunc, borderColor, minLOD, maxLOD, shaderVisibility, registerSpace);
    }
};
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
    ...
    static inline void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE &handle,
                                     ...
                                     UINT descriptorIncrementSize)
    {
        handle.ptr = static_cast<SIZE_T>(base.ptr + INT64(offsetInDescriptors) *
                                                        UINT64(descriptorIncrementSize));
    }
};
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
    ...
    static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE &handle,
                                     ...
                                     UINT descriptorIncrementSize)
    {
        handle.ptr = static_cast<UINT64>(base.ptr + INT64(offsetInDescriptors) *
                                                        UINT64(descriptorIncrementSize));
    }
};
                                              ...
                                              UINT NumSubresources)
{
    ...
    pDevice->GetCopyableFootprints(&Desc, FirstSubresource, NumSubresources, 0, nullptr, nullptr,
                                 ...
                                 _In_reads_(NumSubresources) D3D12_SUBRESOURCE_DATA *pSrcData)
{
    ...
    UINT64 Result = UpdateSubresources(pCmdList, pDestinationResource, pIntermediate,
                                       FirstSubresource, NumSubresources, RequiredSize, pLayouts,
